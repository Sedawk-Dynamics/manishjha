...
export function InternationalAssignments() {
  const assignments = [
    {
      country: 'Russia',
      region: 'Zaporizhzhia, Moscow',
      period: '2024-2025',
      highlights: 'Nuclear Plant Report, Honest View Award 2025',
      color: 'from-red-500/20 to-red-600/20',
    },
    {
      country: 'Ukraine',
      region: 'Kyiv, Lviv, War Zone',
      period: '2023-2024',
      highlights: 'War Front Reporting, Conflict Analysis',
      color: 'from-blue-500/20 to-blue-600/20',
    },
    {
      country: 'Israel & Gaza',
      region: 'Jerusalem, Gaza Strip',
      period: '2023-2025',
      highlights: 'Crisis Coverage, Diplomatic Analysis',
    ...
    },
    {
      ...
      region: 'Tehran',
      period: '2024',
      highlights: 'Geopolitical Analysis, Nuclear Diplomacy',
      color: 'from-green-500/20 to-green-600/20',
    },
    {
      country: 'United States',
      region: 'Washington D.C., White House',
      period: '2024-2025',
      highlights: 'Presidential Interview, Diplomatic Coverage',
      color: 'from-blue-500/20 to-indigo-600/20',
    },
    {
      country: 'South Asia',
      region: 'India, Pakistan, Afghanistan',
      period: 'Ongoing',
